...
struct AppIcon * __AddAppIconA(__reg("a6") void *, __reg("d0") ULONG id, __reg("d1") ULONG userdata, __reg("a0") UBYTE * text, __reg("a1") struct MsgPort * msgport, __reg("a2") struct FileLock * lock, __reg("a3") struct DiskObject * diskobj, __reg("a4") struct TagItem * taglist)="\tjsr\t-60(a6)";
...
#if !defined(NO_INLINE_STDARG) && (__STDC__ == 1L) && (__STDC_VERSION__ >= 199901L)
struct AppIcon * __AddAppIcon(__reg("a6") void *, __reg("d0") ULONG id, __reg("d1") ULONG userdata, __reg("a0") UBYTE * text, __reg("a1") struct MsgPort * msgport, __reg("a2") struct FileLock * lock, __reg("a3") struct DiskObject * diskobj, Tag taglist, ...)="\tmove.l\ta4,-(a7)\n\tlea\t4(a7),a4\n\tjsr\t-60(a6)\n\tmovea.l\t(a7)+,a4";
